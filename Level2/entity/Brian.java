...
public class Brian extends Entity
{
    ...
    public void getPlayerImage()
    {
        try
        {
            up1 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-up-1.png"));
            up2 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-up-2.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-right-1.png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-right-2.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-left-1.png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-left-2.png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-down-1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/playerImport/brain-down-2.png"));
