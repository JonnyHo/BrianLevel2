...
public class TileManager {
    ...
    public TileManager(GameManager gm)
    {
        ...
        getTileImage();
        loadMap("/mapsImport/mapDataV2.txt");
    }
    ...
    public void getTileImage()
    {
        try {
            ...
            parentTile[0].image = ImageIO.read(getClass().getResourceAsStream("/tilesImport/carpet.png.png"));

            parentTile[1] = new ParentTile();
            parentTile[1].image = ImageIO.read(getClass().getResourceAsStream("/tilesImport/wall.png"));
            parentTile[1].collision = true;

            parentTile[2] = new ParentTile();
            parentTile[2].image = ImageIO.read(getClass().getResourceAsStream("/tilesImport/water.png"));
            parentTile[2].collision = true;

            parentTile[3] = new ParentTile();
            parentTile[3].image = ImageIO.read(getClass().getResourceAsStream("/tilesImport/earth.png"));

            parentTile[4] = new ParentTile();
            parentTile[4].image = ImageIO.read(getClass().getResourceAsStream("/tilesImport/computer.png.png"));
            parentTile[4].collision = true;

            parentTile[5] = new ParentTile();
            parentTile[5].image = ImageIO.read(getClass().getResourceAsStream("/tilesImport/path.png"));
